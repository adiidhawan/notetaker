...
INSERT INTO "new_Meeting" ("aiNotes", "aiSummary", "audioRecording", "createdAt", "duration", "endTime", "id", "recallBotId", "shareExpiration", "sharePassword", "shareRevoked", "shareToken", "startTime", "title", "transcript", "updatedAt", "url", "userId", "videoRecording") SELECT "aiNotes", "aiSummary", "audioRecording", "createdAt", "duration", "endTime", "id", "recallBotId", "shareExpiration", "sharePassword", "shareRevoked", "shareToken", "startTime", "title", "transcript", "updatedAt", "url", "userId", "videoRecording" FROM "Meeting";
DROP TABLE "Meeting";
